<?php
require_once(LIB_PATH.'Umeng/notification/android/AndroidBroadcast.php');
require_once(LIB_PATH.'Umeng/notification/android/AndroidFilecast.php');
require_once(LIB_PATH.'Umeng/notification/android/AndroidGroupcast.php');
require_once(LIB_PATH.'Umeng/notification/android/AndroidUnicast.php');
require_once(LIB_PATH.'Umeng/notification/android/AndroidCustomizedcast.php');
require_once(LIB_PATH.'Umeng/notification/ios/IOSBroadcast.php');
require_once(LIB_PATH.'Umeng/notification/ios/IOSFilecast.php');
require_once(LIB_PATH.'Umeng/notification/ios/IOSGroupcast.php');
require_once(LIB_PATH.'Umeng/notification/ios/IOSUnicast.php');
require_once(LIB_PATH.'Umeng/notification/ios/IOSCustomizedcast.php');
...
class Umeng {
	...
	function __construct($param) {
		...
		$this->appMasterSecret = $param['secret'];
	...
	function sendIOSBroadcast($test) {
		try {
			...
			$brocast->setPredefinedKeyValue("alert", $test);
	...
	function sendIOSUnicast($test) {
		try {
			...
			$unicast->setPredefinedKeyValue("timestamp",        $this->timestamp);
			// Set your device tokens here
			$unicast->setPredefinedKeyValue("device_tokens",$test['device_tokens']); 
			$unicast->setPredefinedKeyValue("alert",$test['text']);
