...
class base_adposition_db {
	//Db
	private $db = NULL;
	//database table
	private $table = 'base_adposition';
	//数据结果
	...
	public function __construct(&$db){
		$this->db = $db;
		$this->table = DB_PREFIX . 'base_adposition';
	}
	...
	public function getlist($param){
		...
		$data  = $this->db->select($this->table.' a ', 'a.id, a.adName, a.sort, a.details, a.adLink, a.photoUrl, a.createDate ', $where);
		if(!empty($data))
		{
