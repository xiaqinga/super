...
class base_activity_db {
	//Db
	private $db = NULL;
	//database table
	private $table = 'base_activity';
	...
	public function __construct(&$db){
		$this->db = $db;
		$this->table = DB_PREFIX . 'base_activity';
		$this->list = DB_PREFIX . 'goods_list';
		$this->act_goods = DB_PREFIX . 'base_activity_goods';
	...
	public function updateActivityGoodsById($param){
		...
		and goodsId NOT IN(".$param['goodsIds'].")";
