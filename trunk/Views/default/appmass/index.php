<div class="content-top">
	<form class="sui-form" id="search">
		<div class="controls">
			...
			--><?php echo form_a_auth(array('content'=>'添加群发','check'=>'appmass/edit','class'=>'btn-large','url'=>APP_URL.'appmass/edit?ref='.$ref));?>
		</div>
	</form>
</div>
<div class="user-list">
...
_pagedata.url = "appmass/ajaxIndex?searchname="+searchname+"&name="+name+"&pagesize=<?php echo $page['pagesize'];?>&page=";
