...
<form id="norms_edit-form" class="sui-form form-horizontal sui-validate" novalidate="novalidate">
  ...
  <input type="hidden" name="isGiveScore" id="isGiveScore" value="<?php echo $isGiveScore;?>" />
...
//编辑时获取数据库中组合的商品
$.post("<?php echo APP_URL;?>goods_list/getpartgoods?random=" + (new Date()),
    {'goodsId': $("#id").val(),'isGiveScore':$("#isGiveScore").val()},
    function (data)
    {
