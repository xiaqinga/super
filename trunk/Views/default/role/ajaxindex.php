...
<table class="sui-table table-bordered-simple">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="center">
      	<?php echo form_a_auth(array('content'=>'修改','class'=>'btn-link','url'=>APP_URL.'role/edit?id='.$rs['id'].'&ref='.urlencode($ref),'img'=>'update.png'));?>
      	<?php echo form_a_auth(array('content'=>'删除','class'=>'btn-link role-delete','url'=>APP_URL.'role/delete','rid'=>$rs['id'],'img'=>'delete.png'));?>
      	<?php echo form_a_auth(array('content'=>'修改权限','class'=>'btn-link setpermissions','url'=>'role/permissions','rem'=>APP_URL.'role/permissions?id='.$rs['id'].'&ref='.urlencode($ref),'img'=>'setup.png'));?>
      </td>
    </tr>
    <?php }?>
  </tbody>
