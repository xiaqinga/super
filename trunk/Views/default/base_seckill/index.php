...
<ul class="sui-nav nav-tabs nav-primary">
  <li class="active" onclick="navclick('index');"><a>预约秒抢</a></li>
  <li onclick="navclick('ordinary');"><a>普通秒抢</a></li>
</ul>
<div class="content-top ">
	<form class="sui-form" id="search">
	 <div class="controls">
      ...
      <?php echo form_a_auth(array('content'=>'秒抢管理','class'=>'btn-large','url'=>APP_URL.'base_seckill/edit?goodsType=0&id='.$bid.'&ref='.urlencode($ref)));?>
      <?php echo form_a_auth(array('content'=>'添加预约商品时间段','check'=>'base_seckill/check','class'=>'btn-large','url'=>APP_URL.'base_seckill/addgoods?goodsType=0&ref='.$ref));?>
    </div>
	</form>
</div>
...
_pagedata.url = "base_seckill/ajaxIndex?key_type="+key_type+"&key="+key+"&pagesize=<?php echo $page['pagesize'];?>&page=";
