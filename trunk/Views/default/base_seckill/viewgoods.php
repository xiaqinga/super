...
<div class="content-top">
  <form class="sui-form" id="viewsearch">
    <input type="hidden" id="goodsIds" name="goodsIds" value="<?php echo $goodsIds;?>" >
      ...
      <button type="submit" id="viewsearch-bn" data-url="base_seckill/viewGoods" class="sui-btn btn-large btn-primary">查询</button>
    </div>
  </form>
</div>
...
$(function(){
    ...
    _pagedata.url = "base_seckill/ajaxGoods?goodsType="+goodsType+"&goodsName="+encodeURIComponent(goodsName)+"&goodsIds="+goodsIds+"&pagesize=<?php echo $page['pagesize'];?>&page=";
...
function render_goods(obj){
  $.each(obj, function(i, v) {
     $("#addgoods_list").append("<tr>"+
      ...
      "<td class=\"center\">"+
        "<a href=\"javascript:void(0);\" class=\"sui-btn btn-link base_activity-delete\" data-id=\"2\"><img class=\"imgtable\" src=\"<?php echo ASSETS_URL;?>images/default/invalid.png\"></a></td>"+
      "<td></td>"+
    "</tr>")
     var goodsIds =  $("#goodsIds").val();
     if(goodsIds){
