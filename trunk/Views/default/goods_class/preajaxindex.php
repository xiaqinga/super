...
<table class="sui-table table-bordered-simple">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="center">
      	<?php echo form_a_auth(array('content'=>'修改','class'=>'btn-link','url'=>APP_URL.'goods_class/preedit?id='.$rs['id'].'&ref='.urlencode($ref),'img'=>'update.png'));?>
...
<table class="sui-table table-bordered-simple">
	<tbody>
	    <tr>
	      <td class="center">亲，你还没有添加预约商品分类</td>
    	</tr>
	</tbody>
</table>
<?php }?>
