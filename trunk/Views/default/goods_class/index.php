<ul class="sui-nav nav-tabs nav-xlarge">
  ...
  <li class="active" onclick="s_navclick('index');"><a>普通商品分类</a></li>
  <?php endif;?>
</ul>
<div class="content-top">
  <form class="sui-form" id="search">
    <div class="controls">
      ...
      <button type="submit" id="search-bn" data-url="goods_class/index" class="sui-btn btn-large btn-primary">查询</button>
      <?php echo form_a_auth(array('content'=>'添加','class'=>'btn-large','check'=>'goods_class/add','url'=>APP_URL.'goods_class/edit?ref='.$ref));?>
...
_pagedata.url = "goods_class/ajaxIndex?key_type="+key_type+"&key="+key+"&pagesize=<?php echo $page['pagesize'];?>&page=";
