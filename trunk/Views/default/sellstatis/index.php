...
<ul class="sui-nav nav-tabs tab-wraped">
    ...
    <li><a href="javascript:;" data-url="<?php echo APP_URL.'sellstatis/indexunion';?>" data-toggle="tab" >
		...
		<div class="content-top" style="margin: -3px auto;">
			<form class="sui-form" id="search">
				<div class="controls">
					...
					<button type="submit" id="pr-search-bn" data-url="sellstatis/index" class="sui-btn btn-large btn-primary">查询</button>
				</div>
			</form>
		</div>
	</div>
		...
		<div class="content-top" style="margin: -3px auto;">
			<form class="sui-form" id="search">
				...
				<div class="controls">
					...
					<button type="submit" id="search-bn" data-url="sellstatis/index" class="sui-btn btn-large btn-primary">查询</button>
				</div>
			</form>
		</div>
	</div>
