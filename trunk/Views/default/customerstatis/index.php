...
<ul class="sui-nav nav-tabs tab-wraped">
    ...
    <li><a href="javascript:;" data-url="<?php echo APP_URL.'customerstatis/indexbusiness';?>" data-toggle="tab" >
...
<div class="customerstatis-list">
	<table class="sui-table table-bordered-simple">
	  <thead>
	    <tr class="thbk">
	      <th class="center">金星创客</th>
		  <th class="center">银星创客</th>
	      <th class="center">总会员数</th>
	    </tr>
	  </thead>
	  <tbody>
	  	<tr>
	  		<td class="center"><?php echo $makergoldCount;?></td>
	  		<td class="center"><?php echo $makersilverCount;?></td>
		...
		<div class="content-top" style="margin: -3px auto;">
			<form class="sui-form" id="search">
				<div class="controls">
					...
					<button type="submit" id="search-bn" data-url="<?php echo APP_URL;?>customerstatis/index" class="sui-btn btn-large btn-primary">查询</button>
				</div>
			</form>
		</div>
	</div>
