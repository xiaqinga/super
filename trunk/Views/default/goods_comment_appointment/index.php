<ul class="sui-nav nav-tabs nav-xlarge" style="margin-top: 8px;">
  <li onclick="s_navclick('index');"><a>供应商评论</a></li>
  <li class="active" onclick="s_navclick('appointment');"><a>联盟商评论</a></li>
</ul>
<div class="content-top">
  <form class="sui-form" id="search">
    <div class="controls">
      <span class="sui-dropdown dropdown-bordered select downlist_type"><span class="dropdown-inner"><a id="select" role="button" href="javascript:void(0);" data-toggle="dropdown" class="dropdown-toggle">
        <input type="hidden" name="goodsType" id="goodsType" value="PRE">
 ...
 <span class="dropdown-inner">
      ...
      <button type="submit" id="search-bn" data-url="<?php echo APP_URL;?>goods_comment_appointment/index" class="sui-btn btn-large btn-primary">查询</button>
    </div>
  </form>
</div>
<div class="goods_comment_appointment-list">
</div>
...
_pagedata.url = "goods_comment_appointment/ajaxIndex?key_type="+key_type+"&key="+key+"&startDate="+startDate+"&endDate="+endDate+"&pagesize=<?php echo $page['pagesize'];?>&page=";
_pagedata.container = '.goods_comment_appointment-list';
