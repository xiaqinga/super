...
if ( $items && is_array($items) && count($items)):
    foreach($items as $key=>$item):
        if(!empty($item['normsValueA']) && !empty($item['normsValueB'])):
            ?>
            <tr partgoods_id="<?php echo $item['id'];?>" norms_a="<?php echo $item['normsValueAId'];?>" norms_b="<?php echo $item['normsValueBId'];?>" normsvalue_b_add="'<?php echo $item['normsvalue_b_add'];?>" normsvalue_a_add="<?php echo $item['normsvalue_a_add'];?>" class="js_sizes_1_<?php echo $item['normsValueAId'];?>_<?php echo $item['normsValueAOrder'];?> js_sizes_2_<?php echo $item['normsValueBId'];?>_<?php echo $item['normsValueBOrder'];?>">
                    <td class="js_sizes_a" style="word-break: break-all;word-wrap:break-word;"><?php echo $item['normsValueA'];?></td>
                    <td class="js_sizes_b" style="word-break: break-all;word-wrap:break-word;"><?php echo $item['normsValueB'];?></td>
                    <td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_restockPrice" name="js_restockPrice" type="text" value="<?php echo $item['preferentialPrice'];?>" onchange="Size.qq(this);"></td>
                    <td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_stockNum" type="text" value="<?php echo $item['stockNum'];?>"></td>
                    <td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_weight" type="text" value="<?php echo $item['weight'];?>"></td>
                    <td style="word-break: break-all;word-wrap:break-word;">

                <input  class="input-medium js_originalPrice"  readonly name="js_originalPrice" type="text" value="<?php echo $item['discount'];?>" >
                ...
                <!-- <td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_originalPrice" type="text" value="'.$item['originalPrice'].'"></td> -->
                    <td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_preferentialPrice" onchange="Size.zz(this);" type="text" value="<?php echo $item['restockPrice'];?>" name="js_preferentialPrice"></td>
                </tr>
        <?php 
        elseif(!empty($item['normsValueA'])):
          ?>
            <tr partgoods_id="<?php echo $item['id'];?>" norms_a="<?php echo $item['normsValueAId'];?>" normsvalue_a_add="<?php echo $item['normsvalue_a_add'];?>" class="js_sizes_1_<?php echo $item['normsValueAId'];?>_<?php echo $item['normsValueAOrder'];?>">
                  <td class="js_sizes_a" style="word-break: break-all;word-wrap:break-word;"><?php echo $item['normsValueA'];?></td>
                    <td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_restockPrice" name="js_restockPrice" type="text" value="<?php echo $item['preferentialPrice'];?>" onchange="Size.qq(this);"></td>
                    <td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_stockNum" type="text" value="<?php echo $item['stockNum'];?>"></td>
                    <td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_weight" type="text" value="<?php echo $item['weight'];?>"></td>
                    ...
                    <!-- <td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_originalPrice" type="text" value="'.$item['originalPrice'].'"></td> -->
                    <td style="word-break: break-all;word-wrap:break-word;"><input min="0"  onchange="Size.zz(this);" class="input-medium js_preferentialPrice" type="text" value="<?php echo $item['restockPrice'];?>" name="js_preferentialPrice"></td>
                </tr>
        <?php
        endif;
    endforeach;
...
<script type="text/javascript">
  ...
  $("#norms_edit-form").on('change', 'select', function(){
      $(".js_btn_submit").show(); //显示确认
  })
