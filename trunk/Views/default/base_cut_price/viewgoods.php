...
<div class="content-top">
  <form class="sui-form" id="viewsearch">
    <input type="hidden" id="goodsIds" name="goodsIds" value="<?php echo $goodsIds;?>" >
      ...
      <button type="submit" id="viewsearch-bn" data-url="base_cut_price/viewGoods" class="sui-btn btn-large btn-primary">查询</button>
    </div>
  </form>
</div>
...
$(function(){
    ...
    _pagedata.url = "base_cut_price/ajaxGoods?goodsType="+goodsType+"&goodsName="+encodeURIComponent(goodsName)+"&goodsIds="+goodsIds+"&pagesize=<?php echo $page['pagesize'];?>&page=";
