<!--<ul class="sui-nav nav-tabs nav-xlarge" style="margin-top: 8px;">
  <li class="active" onclick="s_navclick('index');"><a>创客大赛</a></li>
  <li onclick="s_navclick('submission');"><a>需求征集</a></li>
</ul>-->
<div class="content-top">
	<form class="sui-form" id="search">
     ...
     <span class="sui-dropdown dropdown-bordered select downlist_type"><span class="dropdown-inner"><a id="select" role="button" href="javascript:void(0);" data-toggle="dropdown" class="dropdown-toggle">
        ...
        <ul role="menu" aria-labelledby="drop2" class="sui-dropdown-menu">
          ...
          <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:void(0);" value="activityName">大赛名称</a></li>
    ...
    <button type="submit" id="search-bn" data-url="<?php echo APP_URL;?>base_startup_game/index" class="sui-btn btn-large btn-primary">查询</button>
    <?php echo form_a_auth(array('content'=>'添加大赛','class'=>'btn-large','check'=>'base_startup_game/add','url'=>APP_URL.'base_startup_game/edit?ref='.$ref));?>
		</div>
	</form>
</div>
...
_pagedata.url = "base_startup_game/ajaxIndex?key_type="+key_type+"&key="+key+"&pagesize=<?php echo $page['pagesize'];?>&page=";
