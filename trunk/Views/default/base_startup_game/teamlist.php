...
_pagedata.url = "base_startup_game/ajaxteamlist?gameId="+gameId+"&key_type="+key_type+"&key="+key+"&pagesize=<?php echo $page['pagesize'];?>&page=";
...
SAYIMO.pagination(_pagedata);
  ...
  {
    if(url == "info"){
      SAYIMO.go_url("<?php echo APP_URL;?>base_startup_game/info?id=<?php echo $id;?>");
    }
    if(url == "teamlist"){
