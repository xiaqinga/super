  ...
  <div class="control-group">
  	...
  	<tbody>
	    ...
	    <tr>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img0" style="width: 133px; height: 133px;border:1px solid #eaeaea;cursor: pointer;" onclick="uploadImg('0','720','380');" src="<?php echo (isset($indexs[0]['detail'][0]['photoUrl']) && !empty($indexs[0]['detail'][0]['photoUrl']))?$indexs[0]['detail'][0]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      ...
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img1" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('1','720','380');" src="<?php echo (isset($indexs[0]['detail'][1]['photoUrl']) && !empty($indexs[0]['detail'][1]['photoUrl']))?$indexs[0]['detail'][1]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      ...
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img2" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('2','720','380');" src="<?php echo (isset($indexs[0]['detail'][2]['photoUrl']) && !empty($indexs[0]['detail'][2]['photoUrl']))?$indexs[0]['detail'][2]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      ...
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img3" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('3','720','380');" src="<?php echo (isset($indexs[0]['detail'][3]['photoUrl']) && !empty($indexs[0]['detail'][3]['photoUrl']))?$indexs[0]['detail'][3]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	    ...
	    <tr>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img4" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('4','720','380');" src="<?php echo (isset($indexs[0]['detail'][4]['photoUrl']) && !empty($indexs[0]['detail'][4]['photoUrl']))?$indexs[0]['detail'][4]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn4"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName4" type="text" value="<?php echo (isset($indexs[0]['detail'][4]['relName']))?$indexs[0]['detail'][4]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      		...
	      		<img onclick="actionUrl(4);" align="right" value="" name="relName0" placeholder="请选择跳转位置" style="width: 14px;height:15px;margin-right:-2px;border-right:1px solid #eaeaea;padding-right:10px;padding-top:7px;padding-bottom:5px;margin-top:1px;cursor:pointer;" src="<?php echo ASSETS_URL;?>images/default/update.png" >
	      	</div>
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(720*380px)</span>
				<input id="relId4" type="hidden" value="<?php echo (isset($indexs[0]['detail'][4]['relId']))?$indexs[0]['detail'][4]['relId']:'';?>" name="goodsIndexs[0][goodsIndexDetails][4][relId]" style="width: 120px;">
				<input id="detailId4" type="hidden" value="<?php echo (isset($indexs[0]['detail'][4]['id']))?$indexs[0]['detail'][4]['id']:'';?>" name="goodsIndexs[0][goodsIndexDetails][4][id]" style="width: 120px;">
				<input id="type4" type="hidden" value="<?php echo (isset($indexs[0]['detail'][4]['type']))?$indexs[0]['detail'][4]['type']:'';?>" name="goodsIndexs[0][goodsIndexDetails][4][type]" style="width: 120px;">
				<input id="url4" type="hidden" value="<?php echo (isset($indexs[0]['detail'][4]['url']))?$indexs[0]['detail'][4]['url']:'';?>" name="goodsIndexs[0][goodsIndexDetails][4][url]" style="width: 120px;">
				<input id="photoUrl4" type="hidden" value="<?php echo (isset($indexs[0]['detail'][4]['photoUrl']))?$indexs[0]['detail'][4]['photoUrl']:'';?>" name="goodsIndexs[0][goodsIndexDetails][4][photoUrl]" style="width: 120px;">
			</div>
	      </td>
  ...
  <div class="control-group">
  	...
  	<tbody>
	    ...
	    <tr>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img13" style="width: 133px; height: 133px;border:1px solid #eaeaea;cursor: pointer;" onclick="uploadImg('13','360','360');" src="<?php echo (isset($indexs[2]['detail'][0]['photoUrl']) && !empty($indexs[2]['detail'][0]['photoUrl']))?$indexs[2]['detail'][0]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      ...
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img14" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('14','360','180');" src="<?php echo (isset($indexs[2]['detail'][1]['photoUrl']) && !empty($indexs[2]['detail'][1]['photoUrl']))?$indexs[2]['detail'][1]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      ...
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img15" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('15','360','180');" src="<?php echo (isset($indexs[2]['detail'][2]['photoUrl']) && !empty($indexs[2]['detail'][2]['photoUrl']))?$indexs[2]['detail'][2]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      ...
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img16" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('16','360','180');" src="<?php echo (isset($indexs[2]['detail'][3]['photoUrl']) && !empty($indexs[2]['detail'][3]['photoUrl']))?$indexs[2]['detail'][3]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	    ...
	    <tr>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img17" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('17','360','180');" src="<?php echo (isset($indexs[2]['detail'][4]['photoUrl']) && !empty($indexs[2]['detail'][4]['photoUrl']))?$indexs[2]['detail'][4]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn17"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName17" type="text" value="<?php echo (isset($indexs[2]['detail'][4]['relName']))?$indexs[2]['detail'][4]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      		...
	      		<img onclick="actionUrl(17);" align="right" value="" name="relName0" placeholder="请选择跳转位置" style="width: 14px;height:15px;margin-right:-2px;border-right:1px solid #eaeaea;padding-right:10px;padding-top:7px;padding-bottom:5px;margin-top:1px;cursor:pointer;" src="<?php echo ASSETS_URL;?>images/default/update.png" >
	      	</div>
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(360*180px)</span>
				<input id="relId17" type="hidden" value="<?php echo (isset($indexs[2]['detail'][4]['relId']))?$indexs[2]['detail'][4]['relId']:'';?>" name="goodsIndexs[2][goodsIndexDetails][4][relId]" style="width: 120px;">
				<input id="detailId17" type="hidden" value="<?php echo (isset($indexs[2]['detail'][4]['id']))?$indexs[2]['detail'][4]['id']:'';?>" name="goodsIndexs[2][goodsIndexDetails][4][id]" style="width: 120px;">
				<input id="type17" type="hidden" value="<?php echo (isset($indexs[2]['detail'][4]['type']))?$indexs[2]['detail'][4]['type']:'';?>" name="goodsIndexs[2][goodsIndexDetails][4][type]" style="width: 120px;">
				<input id="url17" type="hidden" value="<?php echo (isset($indexs[2]['detail'][4]['url']))?$indexs[2]['detail'][4]['url']:'';?>" name="goodsIndexs[2][goodsIndexDetails][4][url]" style="width: 120px;">
				<input id="photoUrl17" type="hidden" value="<?php echo (isset($indexs[2]['detail'][4]['photoUrl']))?$indexs[2]['detail'][4]['photoUrl']:'';?>" name="goodsIndexs[2][goodsIndexDetails][4][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td style="width: 20%"></td>
	      <td style="width: 20%"></td>
  ...
  <div class="control-group">
  	...
  	<tbody>
	    ...
	    <tr>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img18" style="width: 133px; height: 133px;border:1px solid #eaeaea;cursor: pointer;" onclick="uploadImg('18','720','230');" src="<?php echo (isset($indexs[3]['detail'][0]['photoUrl']) && !empty($indexs[3]['detail'][0]['photoUrl']))?$indexs[3]['detail'][0]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
  ...
  <div class="control-group">
  	...
  	<tbody>
	    ...
	    <tr>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img19" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('19','240','350');" src="<?php echo (isset($indexs[4]['detail'][0]['photoUrl']) && !empty($indexs[4]['detail'][0]['photoUrl']))?$indexs[4]['detail'][0]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn19"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName19" type="text" value="<?php echo (isset($indexs[4]['detail'][0]['relName']))?$indexs[4]['detail'][0]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      	...
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				...
				<input id="relId19" type="hidden" value="<?php echo (isset($indexs[4]['detail'][0]['relId']))?$indexs[4]['detail'][0]['relId']:'';?>" name="goodsIndexs[4][goodsIndexDetails][0][relId]" style="width: 120px;">
				<input id="detailId19" type="hidden" value="<?php echo (isset($indexs[4]['detail'][0]['id']))?$indexs[4]['detail'][0]['id']:'';?>" name="goodsIndexs[4][goodsIndexDetails][0][id]" style="width: 120px;">
				<input id="type19" type="hidden" value="<?php echo (isset($indexs[4]['detail'][0]['type']))?$indexs[4]['detail'][0]['type']:'';?>" name="goodsIndexs[4][goodsIndexDetails][0][type]" style="width: 120px;">
				<input id="url19" type="hidden" value="<?php echo (isset($indexs[4]['detail'][0]['url']))?$indexs[4]['detail'][0]['url']:'';?>" name="goodsIndexs[4][goodsIndexDetails][0][url]" style="width: 120px;">
				<input id="photoUrl19" type="hidden" value="<?php echo (isset($indexs[4]['detail'][0]['photoUrl']))?$indexs[4]['detail'][0]['photoUrl']:'';?>" name="goodsIndexs[4][goodsIndexDetails][0][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img20" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('20','240','350');" src="<?php echo (isset($indexs[4]['detail'][1]['photoUrl']) && !empty($indexs[4]['detail'][1]['photoUrl']))?$indexs[4]['detail'][1]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn20"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName20" type="text" value="<?php echo (isset($indexs[4]['detail'][1]['relName']))?$indexs[4]['detail'][1]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      	...
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(240*350px)</span>
				<input id="relId20" type="hidden" value="<?php echo (isset($indexs[4]['detail'][1]['relId']))?$indexs[4]['detail'][1]['relId']:'';?>" name="goodsIndexs[4][goodsIndexDetails][1][relId]" style="width: 120px;">
				<input id="detailId20" type="hidden" value="<?php echo (isset($indexs[4]['detail'][1]['id']))?$indexs[4]['detail'][1]['id']:'';?>" name="goodsIndexs[4][goodsIndexDetails][1][id]" style="width: 120px;">
				<input id="type20" type="hidden" value="<?php echo (isset($indexs[4]['detail'][1]['type']))?$indexs[4]['detail'][1]['type']:'';?>" name="goodsIndexs[4][goodsIndexDetails][1][type]" style="width: 120px;">
				<input id="url20" type="hidden" value="<?php echo (isset($indexs[4]['detail'][1]['url']))?$indexs[4]['detail'][1]['url']:'';?>" name="goodsIndexs[4][goodsIndexDetails][1][url]" style="width: 120px;">
				<input id="photoUrl20" type="hidden" value="<?php echo (isset($indexs[4]['detail'][1]['photoUrl']))?$indexs[4]['detail'][1]['photoUrl']:'';?>" name="goodsIndexs[4][goodsIndexDetails][1][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img21" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('21','240','350');" src="<?php echo (isset($indexs[4]['detail'][2]['photoUrl']) && !empty($indexs[4]['detail'][2]['photoUrl']))?$indexs[4]['detail'][2]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      ...
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img22" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('22','360','180');" src="<?php echo (isset($indexs[4]['detail'][3]['photoUrl']) && !empty($indexs[4]['detail'][3]['photoUrl']))?$indexs[4]['detail'][3]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn22"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName22" type="text" value="<?php echo (isset($indexs[4]['detail'][3]['relName']))?$indexs[4]['detail'][3]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      	...
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(360*180px)</span>
				<input id="relId22" type="hidden" value="<?php echo (isset($indexs[4]['detail'][3]['relId']))?$indexs[4]['detail'][3]['relId']:'';?>" name="goodsIndexs[4][goodsIndexDetails][3][relId]" style="width: 120px;">
				<input id="detailId22" type="hidden" value="<?php echo (isset($indexs[4]['detail'][3]['id']))?$indexs[4]['detail'][3]['id']:'';?>" name="goodsIndexs[4][goodsIndexDetails][3][id]" style="width: 120px;">
				<input id="type22" type="hidden" value="<?php echo (isset($indexs[4]['detail'][3]['type']))?$indexs[4]['detail'][3]['type']:'';?>" name="goodsIndexs[4][goodsIndexDetails][3][type]" style="width: 120px;">
				<input id="url22" type="hidden" value="<?php echo (isset($indexs[4]['detail'][3]['url']))?$indexs[4]['detail'][3]['url']:'';?>" name="goodsIndexs[4][goodsIndexDetails][3][url]" style="width: 120px;">
				<input id="photoUrl22" type="hidden" value="<?php echo (isset($indexs[4]['detail'][3]['photoUrl']))?$indexs[4]['detail'][3]['photoUrl']:'';?>" name="goodsIndexs[4][goodsIndexDetails][3][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td valign="middle" rowspan="2" class="center" style="border-left: 1px solid #e6e6e6;">
	   ...
	   <tr>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img23" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('23','360','180');" src="<?php echo (isset($indexs[4]['detail'][4]['photoUrl']) && !empty($indexs[4]['detail'][4]['photoUrl']))?$indexs[4]['detail'][4]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn23"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName23" type="text" value="<?php echo (isset($indexs[4]['detail'][4]['relName']))?$indexs[4]['detail'][4]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      	...
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(360*180px)</span>
				<input id="relId23" type="hidden" value="<?php echo (isset($indexs[4]['detail'][4]['relId']))?$indexs[4]['detail'][4]['relId']:'';?>" name="goodsIndexs[4][goodsIndexDetails][4][relId]" style="width: 120px;">
				<input id="detailId23" type="hidden" value="<?php echo (isset($indexs[4]['detail'][4]['id']))?$indexs[4]['detail'][4]['id']:'';?>" name="goodsIndexs[4][goodsIndexDetails][4][id]" style="width: 120px;">
				<input id="type23" type="hidden" value="<?php echo (isset($indexs[4]['detail'][4]['type']))?$indexs[4]['detail'][4]['type']:'';?>" name="goodsIndexs[4][goodsIndexDetails][4][type]" style="width: 120px;">
				<input id="url23" type="hidden" value="<?php echo (isset($indexs[4]['detail'][4]['url']))?$indexs[4]['detail'][4]['url']:'';?>" name="goodsIndexs[4][goodsIndexDetails][4][url]" style="width: 120px;">
				<input id="photoUrl23" type="hidden" value="<?php echo (isset($indexs[4]['detail'][4]['photoUrl']))?$indexs[4]['detail'][4]['photoUrl']:'';?>" name="goodsIndexs[4][goodsIndexDetails][4][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img24" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('24','360','180');" src="<?php echo (isset($indexs[4]['detail'][5]['photoUrl']) && !empty($indexs[4]['detail'][5]['photoUrl']))?$indexs[4]['detail'][5]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn24"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName24" type="text" value="<?php echo (isset($indexs[4]['detail'][5]['relName']))?$indexs[4]['detail'][5]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      		...
	      		<img onclick="actionUrl(24);" align="right" value="" name="relName" placeholder="请选择跳转位置" style="width: 14px;height:15px;margin-right:-2px;border-right:1px solid #eaeaea;padding-right:24px;padding-top:7px;padding-bottom:5px;margin-top:1px;cursor:pointer;" src="<?php echo ASSETS_URL;?>images/default/update.png" >
	      	</div>
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(360*180px)</span>
				<input id="relId24" type="hidden" value="<?php echo (isset($indexs[4]['detail'][5]['relId']))?$indexs[4]['detail'][5]['relId']:'';?>" name="goodsIndexs[4][goodsIndexDetails][5][relId]" style="width: 120px;">
				<input id="detailId24" type="hidden" value="<?php echo (isset($indexs[4]['detail'][5]['id']))?$indexs[4]['detail'][5]['id']:'';?>" name="goodsIndexs[4][goodsIndexDetails][5][id]" style="width: 120px;">
				<input id="type24" type="hidden" value="<?php echo (isset($indexs[4]['detail'][5]['type']))?$indexs[4]['detail'][5]['type']:'';?>" name="goodsIndexs[4][goodsIndexDetails][5][type]" style="width: 120px;">
				<input id="url24" type="hidden" value="<?php echo (isset($indexs[4]['detail'][5]['url']))?$indexs[4]['detail'][5]['url']:'';?>" name="goodsIndexs[4][goodsIndexDetails][5][url]" style="width: 120px;">
				<input id="photoUrl24" type="hidden" value="<?php echo (isset($indexs[4]['detail'][5]['photoUrl']))?$indexs[4]['detail'][5]['photoUrl']:'';?>" name="goodsIndexs[4][goodsIndexDetails][5][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img25" style="width: 133px; height: 133px;border:1px solid #eaeaea;" onclick="uploadImg('25','360','180');" src="<?php echo (isset($indexs[4]['detail'][6]['photoUrl']) && !empty($indexs[4]['detail'][6]['photoUrl']))?$indexs[4]['detail'][6]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn25"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName25" type="text" value="<?php echo (isset($indexs[4]['detail'][6]['relName']))?$indexs[4]['detail'][6]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      	...
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(360*180px)</span>
				<input id="relId25" type="hidden" value="<?php echo (isset($indexs[4]['detail'][6]['relId']))?$indexs[4]['detail'][6]['relId']:'';?>" name="goodsIndexs[4][goodsIndexDetails][6][relId]" style="width: 120px;">
				<input id="detailId25" type="hidden" value="<?php echo (isset($indexs[4]['detail'][6]['id']))?$indexs[4]['detail'][6]['id']:'';?>" name="goodsIndexs[4][goodsIndexDetails][6][id]" style="width: 120px;">
				<input id="type25" type="hidden" value="<?php echo (isset($indexs[4]['detail'][6]['type']))?$indexs[4]['detail'][6]['type']:'';?>" name="goodsIndexs[4][goodsIndexDetails][6][type]" style="width: 120px;">
				<input id="url25" type="hidden" value="<?php echo (isset($indexs[4]['detail'][6]['url']))?$indexs[4]['detail'][6]['url']:'';?>" name="goodsIndexs[4][goodsIndexDetails][6][url]" style="width: 120px;">
				<input id="photoUrl25" type="hidden" value="<?php echo (isset($indexs[4]['detail'][6]['photoUrl']))?$indexs[4]['detail'][6]['photoUrl']:'';?>" name="goodsIndexs[4][goodsIndexDetails][6][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td style="width: 20%">
	      </td>
  ...
  <div class="control-group">
  	...
  	<tbody>
	    ...
	    <tr>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img26" style="width: 133px; height: 133px;border:1px solid #eaeaea;cursor: pointer;" onclick="uploadImg('26','720','230');" src="<?php echo (isset($indexs[5]['detail'][0]['photoUrl']) && !empty($indexs[5]['detail'][0]['photoUrl']))?$indexs[5]['detail'][0]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn26"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName26" type="text" value="<?php echo (isset($indexs[5]['detail'][0]['relName']))?$indexs[5]['detail'][0]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      		...
	      		<img onclick="actionUrl(26);" align="right" value="" name="relName" placeholder="请选择跳转位置" style="width: 14px;height:15px;margin-right:-2px;border-right:1px solid #eaeaea;padding-right:10px;padding-top:7px;padding-bottom:5px;margin-top:1px;cursor:pointer;" src="<?php echo ASSETS_URL;?>images/default/update.png" >
	      	</div>
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(720*230px)</span>
				<input id="relId26" type="hidden" value="<?php echo (isset($indexs[5]['detail'][0]['relId']))?$indexs[5]['detail'][0]['relId']:'';?>" name="goodsIndexs[5][goodsIndexDetails][0][relId]" style="width: 120px;">
				<input id="detailId26" type="hidden" value="<?php echo (isset($indexs[5]['detail'][0]['id']))?$indexs[5]['detail'][0]['id']:'';?>" name="goodsIndexs[5][goodsIndexDetails][0][id]" style="width: 120px;">
				<input id="type26" type="hidden" value="<?php echo (isset($indexs[5]['detail'][0]['type']))?$indexs[5]['detail'][0]['type']:'';?>" name="goodsIndexs[5][goodsIndexDetails][0][type]" style="width: 120px;">
				<input id="url26" type="hidden" value="<?php echo (isset($indexs[5]['detail'][0]['url']))?$indexs[5]['detail'][0]['url']:'';?>" name="goodsIndexs[5][goodsIndexDetails][0][url]" style="width: 120px;">
				<input id="photoUrl26" type="hidden" value="<?php echo (isset($indexs[5]['detail'][0]['photoUrl']))?$indexs[5]['detail'][0]['photoUrl']:'';?>" name="goodsIndexs[5][goodsIndexDetails][0][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td style="width: 20%">
  ...
  <div class="control-group">
  	...
  	<tbody>
	    ...
	    <tr>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img27" style="width: 133px; height: 133px;border:1px solid #eaeaea;cursor: pointer;" onclick="uploadImg('27','360','360');" src="<?php echo (isset($indexs[6]['detail'][0]['photoUrl']) && !empty($indexs[6]['detail'][0]['photoUrl']))?$indexs[6]['detail'][0]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      ...
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img28" style="width: 133px; height: 133px;border:1px solid #eaeaea;cursor: pointer;" onclick="uploadImg('28','360','180');" src="<?php echo (isset($indexs[6]['detail'][1]['photoUrl']) && !empty($indexs[6]['detail'][1]['photoUrl']))?$indexs[6]['detail'][1]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn28"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName28" type="text" value="<?php echo (isset($indexs[6]['detail'][1]['relName']))?$indexs[6]['detail'][1]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      		...
	      		<img onclick="actionUrl(28);" align="right" value="" name="relName" placeholder="请选择跳转位置" style="width: 14px;height:15px;margin-right:-2px;border-right:1px solid #eaeaea;padding-right:10px;padding-top:7px;padding-bottom:5px;margin-top:1px;cursor:pointer;" src="<?php echo ASSETS_URL;?>images/default/update.png" >
	      	</div>
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(360*180px)</span>
				<input id="relId28" type="hidden" value="<?php echo (isset($indexs[6]['detail'][1]['relId']))?$indexs[6]['detail'][1]['relId']:'';?>" name="goodsIndexs[6][goodsIndexDetails][1][relId]" style="width: 120px;">
				<input id="detailId28" type="hidden" value="<?php echo (isset($indexs[6]['detail'][1]['id']))?$indexs[6]['detail'][1]['id']:'';?>" name="goodsIndexs[6][goodsIndexDetails][1][id]" style="width: 120px;">
				<input id="type28" type="hidden" value="<?php echo (isset($indexs[6]['detail'][1]['type']))?$indexs[6]['detail'][1]['type']:'';?>" name="goodsIndexs[6][goodsIndexDetails][1][type]" style="width: 120px;">
				<input id="url28" type="hidden" value="<?php echo (isset($indexs[6]['detail'][1]['url']))?$indexs[6]['detail'][1]['url']:'';?>" name="goodsIndexs[6][goodsIndexDetails][1][url]" style="width: 120px;">
				<input id="photoUrl28" type="hidden" value="<?php echo (isset($indexs[6]['detail'][1]['photoUrl']))?$indexs[6]['detail'][1]['photoUrl']:'';?>" name="goodsIndexs[6][goodsIndexDetails][1][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img29" style="width: 133px; height: 133px;border:1px solid #eaeaea;cursor: pointer;" onclick="uploadImg('29','180','180');" src="<?php echo (isset($indexs[6]['detail'][2]['photoUrl']) && !empty($indexs[6]['detail'][2]['photoUrl']))?$indexs[6]['detail'][2]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn29"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName29" type="text" value="<?php echo (isset($indexs[6]['detail'][2]['relName']))?$indexs[6]['detail'][2]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      		...
	      		<img onclick="actionUrl(29);" align="right" value="" name="relName" placeholder="请选择跳转位置" style="width: 14px;height:15px;margin-right:-2px;border-right:1px solid #eaeaea;padding-right:10px;padding-top:7px;padding-bottom:5px;margin-top:1px;cursor:pointer;" src="<?php echo ASSETS_URL;?>images/default/update.png" >
	      	</div>
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(180*180px)</span>
				<input id="relId29" type="hidden" value="<?php echo (isset($indexs[6]['detail'][2]['relId']))?$indexs[6]['detail'][2]['relId']:'';?>" name="goodsIndexs[6][goodsIndexDetails][2][relId]" style="width: 120px;">
				<input id="detailId29" type="hidden" value="<?php echo (isset($indexs[6]['detail'][2]['id']))?$indexs[6]['detail'][2]['id']:'';?>" name="goodsIndexs[6][goodsIndexDetails][2][id]" style="width: 120px;">
				<input id="type29" type="hidden" value="<?php echo (isset($indexs[6]['detail'][2]['type']))?$indexs[6]['detail'][2]['type']:'';?>" name="goodsIndexs[6][goodsIndexDetails][2][type]" style="width: 120px;">
				<input id="url29" type="hidden" value="<?php echo (isset($indexs[6]['detail'][2]['url']))?$indexs[6]['detail'][2]['url']:'';?>" name="goodsIndexs[6][goodsIndexDetails][2][url]" style="width: 120px;">
				<input id="photoUrl29" type="hidden" value="<?php echo (isset($indexs[6]['detail'][2]['photoUrl']))?$indexs[6]['detail'][2]['photoUrl']:'';?>" name="goodsIndexs[6][goodsIndexDetails][2][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img30" style="width: 133px; height: 133px;border:1px solid #eaeaea;cursor: pointer;" onclick="uploadImg('30','180','180');" src="<?php echo (isset($indexs[6]['detail'][3]['photoUrl']) && !empty($indexs[6]['detail'][3]['photoUrl']))?$indexs[6]['detail'][3]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn30"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName30" type="text" value="<?php echo (isset($indexs[6]['detail'][3]['relName']))?$indexs[6]['detail'][3]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      		...
	      		<img onclick="actionUrl(30);" align="right" value="" name="relName" placeholder="请选择跳转位置" style="width: 14px;height:15px;margin-right:-2px;border-right:1px solid #eaeaea;padding-right:10px;padding-top:7px;padding-bottom:5px;margin-top:1px;cursor:pointer;" src="<?php echo ASSETS_URL;?>images/default/update.png" >
	      	</div>
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(180*180px)</span>
				<input id="relId30" type="hidden" value="<?php echo (isset($indexs[6]['detail'][3]['relId']))?$indexs[6]['detail'][3]['relId']:'';?>" name="goodsIndexs[6][goodsIndexDetails][3][relId]" style="width: 120px;">
				<input id="detailId30" type="hidden" value="<?php echo (isset($indexs[6]['detail'][3]['id']))?$indexs[6]['detail'][3]['id']:'';?>" name="goodsIndexs[6][goodsIndexDetails][3][id]" style="width: 120px;">
				<input id="type30" type="hidden" value="<?php echo (isset($indexs[6]['detail'][3]['type']))?$indexs[6]['detail'][3]['type']:'';?>" name="goodsIndexs[6][goodsIndexDetails][3][type]" style="width: 120px;">
				<input id="url30" type="hidden" value="<?php echo (isset($indexs[6]['detail'][3]['url']))?$indexs[6]['detail'][3]['url']:'';?>" name="goodsIndexs[6][goodsIndexDetails][3][url]" style="width: 120px;">
				<input id="photoUrl30" type="hidden" value="<?php echo (isset($indexs[6]['detail'][3]['photoUrl']))?$indexs[6]['detail'][3]['photoUrl']:'';?>" name="goodsIndexs[6][goodsIndexDetails][3][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td valign="middle" rowspan="1" class="center" style="border-left: 1px solid #e6e6e6;">
  ...
  <div class="control-group">
  	...
  	<tbody>
	    <tr>
	      <td colspan="5">
		    ...
		    <div class="controls">
		      ...
		      <input type="text" class="input-xlarge input-xfat" id="templateName" name="goodsIndexs[7][templateName]" placeholder="子模板名称" data-rules="required" data-empty-msg="子模板名称不能为空！"  value="<?php echo (isset($indexs[7]['templateName']))?$indexs[7]['templateName']:'';?>">
		      <span class="required">*</span>
		    </div>
		    <label for="inputEmail" class="control-label">URL：</label>
		    <div class="controls">
		      <input type="text" class="input-xlarge input-xfat" id="forUrl" name="goodsIndexs[7][forUrl]" placeholder="请输入网址"  value="<?php echo (isset($indexs[7]['forUrl']))?$indexs[7]['forUrl']:'';?>">
		    </div>
			  <label for="inputEmail" class="control-label">模板状态：</label>
			  <div class="controls">
				  <label class="radio-pretty inline <?php echo $indexs[7]['status']<2?'checked':'' ?>">
					  <input type="radio" <?php echo $indexs[7]['status']<2?'checked':'' ?>  name="goodsIndexs[7][status]" value="1"><span></span>正常
				  </label>
				  <label class="radio-pretty inline <?php echo $indexs[7]['status']==2?'checked':'' ?>">
					  <input type="radio" <?php echo $indexs[7]['status']==2?'checked':'' ?> name="goodsIndexs[7][status]" value="2"><span></span>禁用
				  </label>
	    ...
	    <tr>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img31" style="width: 133px; height: 133px;border:1px solid #eaeaea;cursor: pointer;" onclick="uploadImg('31','720','230');" src="<?php echo (isset($indexs[7]['detail'][0]['photoUrl']) && !empty($indexs[7]['detail'][0]['photoUrl']))?$indexs[7]['detail'][0]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn31"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName31" type="text" value="<?php echo (isset($indexs[7]['detail'][0]['relName']))?$indexs[7]['detail'][0]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      		...
	      		<img onclick="actionUrl(31);" align="right" value="" name="relName" placeholder="请选择跳转位置" style="width: 14px;height:15px;margin-right:-2px;border-right:1px solid #eaeaea;padding-right:10px;padding-top:7px;padding-bottom:5px;margin-top:1px;cursor:pointer;" src="<?php echo ASSETS_URL;?>images/default/update.png" >
	      	</div>
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(720*230px)</span>
				<input id="relId31" type="hidden" value="<?php echo (isset($indexs[7]['detail'][0]['relId']))?$indexs[7]['detail'][0]['relId']:'';?>" name="goodsIndexs[7][goodsIndexDetails][0][relId]" style="width: 120px;">
				<input id="detailId31" type="hidden" value="<?php echo (isset($indexs[7]['detail'][0]['id']))?$indexs[7]['detail'][0]['id']:'';?>" name="goodsIndexs[7][goodsIndexDetails][0][id]" style="width: 120px;">
				<input id="type31" type="hidden" value="<?php echo (isset($indexs[7]['detail'][0]['type']))?$indexs[7]['detail'][0]['type']:'';?>" name="goodsIndexs[7][goodsIndexDetails][0][type]" style="width: 120px;">
				<input id="url31" type="hidden" value="<?php echo (isset($indexs[7]['detail'][0]['url']))?$indexs[7]['detail'][0]['url']:'';?>" name="goodsIndexs[7][goodsIndexDetails][0][url]" style="width: 120px;">
				<input id="photoUrl31" type="hidden" value="<?php echo (isset($indexs[7]['detail'][0]['photoUrl']))?$indexs[7]['detail'][0]['photoUrl']:'';?>" name="goodsIndexs[7][goodsIndexDetails][0][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td style="width: 20%">
...
<div class="control-group">
  	...
  	<tbody>
	    <tr>
	      <td colspan="5">
		    ...
		    <div class="controls">
		      ...
		      <input type="text" class="input-xlarge input-xfat" id="templateName" name="goodsIndexs[8][templateName]" placeholder="子模板名称" data-rules="required" data-empty-msg="子模板名称不能为空！"  value="<?php echo (isset($indexs[8]['templateName']))?$indexs[8]['templateName']:'';?>">
		      <span class="required">*</span>
		    </div>
		    <label for="inputEmail" class="control-label">URL：</label>
		    <div class="controls">
		      <input type="text" class="input-xlarge input-xfat" id="forUrl" name="goodsIndexs[8][forUrl]" placeholder="请输入网址"  value="<?php echo (isset($indexs[8]['forUrl']))?$indexs[8]['forUrl']:'';?>">
		    </div>
			  <label for="inputEmail" class="control-label">模板状态：</label>
			  <div class="controls">
				  <label class="radio-pretty inline <?php echo $indexs[8]['status']<2?'checked':'' ?>">
					  <input type="radio" <?php echo $indexs[8]['status']<2?'checked':'' ?>  name="goodsIndexs[8][status]" value="1"><span></span>正常
				  </label>
				  <label class="radio-pretty inline <?php echo $indexs[8]['status']==2?'checked':'' ?>">
					  <input type="radio" <?php echo $indexs[8]['status']==2?'checked':'' ?> name="goodsIndexs[8][status]" value="2"><span></span>禁用
				  </label>
	    ...
	    <tr>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img32" style="width: 133px; height: 133px;border:1px solid #eaeaea;cursor: pointer;" onclick="uploadImg('32','240','350');" src="<?php echo (isset($indexs[8]['detail'][0]['photoUrl']) && !empty($indexs[8]['detail'][0]['photoUrl']))?$indexs[8]['detail'][0]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn32"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName32" type="text" value="<?php echo (isset($indexs[8]['detail'][0]['relName']))?$indexs[8]['detail'][0]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      		...
	      		<img onclick="actionUrl(32);" align="right" value="" name="relName" placeholder="请选择跳转位置" style="width: 14px;height:15px;margin-right:-2px;border-right:1px solid #eaeaea;padding-right:10px;padding-top:7px;padding-bottom:5px;margin-top:1px;cursor:pointer;" src="<?php echo ASSETS_URL;?>images/default/update.png" >
	      	</div>
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(240*350px)</span>
				<input id="relId32" type="hidden" value="<?php echo (isset($indexs[8]['detail'][0]['relId']))?$indexs[8]['detail'][0]['relId']:'';?>" name="goodsIndexs[8][goodsIndexDetails][0][relId]" style="width: 120px;">
				<input id="detailId32" type="hidden" value="<?php echo (isset($indexs[8]['detail'][0]['id']))?$indexs[8]['detail'][0]['id']:'';?>" name="goodsIndexs[8][goodsIndexDetails][0][id]" style="width: 120px;">
				<input id="type32" type="hidden" value="<?php echo (isset($indexs[8]['detail'][0]['type']))?$indexs[8]['detail'][0]['type']:'';?>" name="goodsIndexs[8][goodsIndexDetails][0][type]" style="width: 120px;">
				<input id="url32" type="hidden" value="<?php echo (isset($indexs[8]['detail'][0]['url']))?$indexs[8]['detail'][0]['url']:'';?>" name="goodsIndexs[8][goodsIndexDetails][0][url]" style="width: 120px;">
				<input id="photoUrl32" type="hidden" value="<?php echo (isset($indexs[8]['detail'][0]['photoUrl']))?$indexs[8]['detail'][0]['photoUrl']:'';?>" name="goodsIndexs[8][goodsIndexDetails][0][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img33" style="width: 133px; height: 133px;border:1px solid #eaeaea;cursor: pointer;" onclick="uploadImg('33','240','350');" src="<?php echo (isset($indexs[8]['detail'][1]['photoUrl']) && !empty($indexs[8]['detail'][1]['photoUrl']))?$indexs[8]['detail'][1]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn33"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName33" type="text" value="<?php echo (isset($indexs[8]['detail'][1]['relName']))?$indexs[8]['detail'][1]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      		...
	      		<img onclick="actionUrl(33);" align="right" value="" name="relName" placeholder="请选择跳转位置" style="width: 14px;height:15px;margin-right:-2px;border-right:1px solid #eaeaea;padding-right:10px;padding-top:7px;padding-bottom:5px;margin-top:1px;cursor:pointer;" src="<?php echo ASSETS_URL;?>images/default/update.png" >
	      	</div>
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(240*350px)</span>
				<input id="relId33" type="hidden" value="<?php echo (isset($indexs[8]['detail'][1]['relId']))?$indexs[8]['detail'][1]['relId']:'';?>" name="goodsIndexs[8][goodsIndexDetails][1][relId]" style="width: 120px;">
				<input id="detailId33" type="hidden" value="<?php echo (isset($indexs[8]['detail'][1]['id']))?$indexs[8]['detail'][1]['id']:'';?>" name="goodsIndexs[8][goodsIndexDetails][1][id]" style="width: 120px;">
				<input id="type33" type="hidden" value="<?php echo (isset($indexs[8]['detail'][1]['type']))?$indexs[8]['detail'][1]['type']:'';?>" name="goodsIndexs[8][goodsIndexDetails][1][type]" style="width: 120px;">
				<input id="url33" type="hidden" value="<?php echo (isset($indexs[8]['detail'][1]['url']))?$indexs[8]['detail'][1]['url']:'';?>" name="goodsIndexs[8][goodsIndexDetails][1][url]" style="width: 120px;">
				<input id="photoUrl33" type="hidden" value="<?php echo (isset($indexs[8]['detail'][1]['photoUrl']))?$indexs[8]['detail'][1]['photoUrl']:'';?>" name="goodsIndexs[8][goodsIndexDetails][1][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img34" style="width: 133px; height: 133px;border:1px solid #eaeaea;cursor: pointer;" onclick="uploadImg('34','240','350');" src="<?php echo (isset($indexs[8]['detail'][2]['photoUrl']) && !empty($indexs[8]['detail'][2]['photoUrl']))?$indexs[8]['detail'][2]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn34"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName34" type="text" value="<?php echo (isset($indexs[8]['detail'][2]['relName']))?$indexs[8]['detail'][2]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      		...
	      		<img onclick="actionUrl(34);" align="right" value="" name="relName" placeholder="请选择跳转位置" style="width: 14px;height:15px;margin-right:-2px;border-right:1px solid #eaeaea;padding-right:10px;padding-top:7px;padding-bottom:5px;margin-top:1px;cursor:pointer;" src="<?php echo ASSETS_URL;?>images/default/update.png" >
	      	</div>
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(240*350px)</span>
				<input id="relId34" type="hidden" value="<?php echo (isset($indexs[8]['detail'][2]['relId']))?$indexs[8]['detail'][2]['relId']:'';?>" name="goodsIndexs[8][goodsIndexDetails][2][relId]" style="width: 120px;">
				<input id="detailId34" type="hidden" value="<?php echo (isset($indexs[8]['detail'][2]['id']))?$indexs[8]['detail'][2]['id']:'';?>" name="goodsIndexs[8][goodsIndexDetails][2][id]" style="width: 120px;">
				<input id="type34" type="hidden" value="<?php echo (isset($indexs[8]['detail'][2]['type']))?$indexs[8]['detail'][2]['type']:'';?>" name="goodsIndexs[8][goodsIndexDetails][2][type]" style="width: 120px;">
				<input id="url34" type="hidden" value="<?php echo (isset($indexs[8]['detail'][2]['url']))?$indexs[8]['detail'][2]['url']:'';?>" name="goodsIndexs[8][goodsIndexDetails][2][url]" style="width: 120px;">
				<input id="photoUrl34" type="hidden" value="<?php echo (isset($indexs[8]['detail'][2]['photoUrl']))?$indexs[8]['detail'][2]['photoUrl']:'';?>" name="goodsIndexs[8][goodsIndexDetails][2][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td style="width: 20%">
	      	<div style="width: 133px;">
	      		<img id="img35" style="width: 133px; height: 133px;border:1px solid #eaeaea;cursor: pointer;" onclick="uploadImg('35','720','230');" src="<?php echo (isset($indexs[8]['detail'][3]['photoUrl']) && !empty($indexs[8]['detail'][3]['photoUrl']))?$indexs[8]['detail'][3]['photoUrl']:ASSETS_URL.'images/default/indextemplate/add_img.png';?>" alt="">
	      		<div style="display: none;" id="upload_btn35"></div>
	      	</div>
	      	<div style="width: 133px;margin-bottom: -2px;">
	      		<input id="spanrelName35" type="text" value="<?php echo (isset($indexs[8]['detail'][3]['relName']))?$indexs[8]['detail'][3]['relName']:'';?>" style="width:60%;background:transparent; border:0px;border-left:1px solid #eaeaea;height:30px;margin-top:-4px;" placeholder="请选择跳转位置">
	      		...
	      		<img onclick="actionUrl(35);" align="right" value="" name="relName" placeholder="请选择跳转位置" style="width: 14px;height:15px;margin-right:-2px;border-right:1px solid #eaeaea;padding-right:10px;padding-top:7px;padding-bottom:5px;margin-top:1px;cursor:pointer;" src="<?php echo ASSETS_URL;?>images/default/update.png" >
	      	</div>
	      	<div style="border: 1px solid #eaeaea;width:133px;">
				<span style="color: #ff9900;line-height:28px;"> 尺寸(720*230px)</span>
				<input id="relId35" type="hidden" value="<?php echo (isset($indexs[8]['detail'][3]['relId']))?$indexs[8]['detail'][3]['relId']:'';?>" name="goodsIndexs[8][goodsIndexDetails][3][relId]" style="width: 120px;">
				<input id="detailId35" type="hidden" value="<?php echo (isset($indexs[8]['detail'][3]['id']))?$indexs[8]['detail'][3]['id']:'';?>" name="goodsIndexs[8][goodsIndexDetails][3][id]" style="width: 120px;">
				<input id="type35" type="hidden" value="<?php echo (isset($indexs[8]['detail'][3]['type']))?$indexs[8]['detail'][3]['type']:'';?>" name="goodsIndexs[8][goodsIndexDetails][3][type]" style="width: 120px;">
				<input id="url35" type="hidden" value="<?php echo (isset($indexs[8]['detail'][3]['url']))?$indexs[8]['detail'][3]['url']:'';?>" name="goodsIndexs[8][goodsIndexDetails][3][url]" style="width: 120px;">
				<input id="photoUrl35" type="hidden" value="<?php echo (isset($indexs[8]['detail'][3]['photoUrl']))?$indexs[8]['detail'][3]['photoUrl']:'';?>" name="goodsIndexs[8][goodsIndexDetails][3][photoUrl]" style="width: 120px;">
			</div>
	      </td>
	      <td valign="middle" rowspan="1" class="center" style="border-left: 1px solid #e6e6e6;">
