	...
	<form class="sui-form" id="search">
		<div class="controls">
	      ...
	      <ul id="menu12" role="menu" aria-labelledby="drop12" class="sui-dropdown-menu">
			...
			<button type="submit" id="search-bn" data-url="<?php echo APP_URL;?>base_enterprise_info/index" class="sui-btn btn-large btn-primary">查询</button>
		<!--	<?php /*echo form_a_auth(array('content'=>'添加联盟商','class'=>'btn-large','check'=>'base_enterprise_info/add','url'=>APP_URL.'base_enterprise_info/edit?ref='.$ref));*/?>
		--></div>
	</form>
</div>
...
$(function(){
	...
	<?php if($providerIdCur):?>
		SAYIMO.go_url("<?php echo APP_URL.'base_enterprise_info/edit?id='.$providerIdCur.'&ref='.$ref;?>");
	<?php endif;?>
	...
	_pagedata.url = "base_enterprise_info/ajaxIndex?"+parameter+"&pagesize=<?php echo $page['pagesize'];?>&page=";
