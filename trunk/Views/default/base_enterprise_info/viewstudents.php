...
<div class="content-top">
  <form class="sui-form" id="viewsearch">
      ...
      <button type="submit" id="viewsearch-bn" data-url="base_enterprise_info/viewstudents" class="sui-btn btn-large btn-primary">查询</button>
    </div>
  </form>
</div>
...
$(function(){
    ...
    _pagedata.url = "base_enterprise_info/ajaxStudents?realName="+encodeURIComponent(realName)+"&pagesize=<?php echo $page['pagesize'];?>&page=";
