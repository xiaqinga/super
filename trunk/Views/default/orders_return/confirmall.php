...
<?php foreach ($list as $k => $rs) :?>
    ...
    <div class="Js_send_item">
      ...
      <textarea rows="3" style="border:1px solid #DDDDDD;height:70px;width:53.5%;margin-left:32px"><?php echo $rs['leaveWords'];?></textarea>
  ...
  function confirm()
  {
    ...
    if(go){
     $.ajax({
        type    : "post",
        async   : false,
        url     : '<?php echo APP_URL."orders_return/confirmAllSendGoods";?>',
