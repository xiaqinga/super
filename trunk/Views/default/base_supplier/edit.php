...
<form id="provider-form" class="sui-form form-horizontal sui-validate" novalidate="novalidate">
  <div class="tab1">
    <div class="control-group">
      ...
      <div class="controls">
        ...
        <input type="text" class="input-xlarge input-xfat" id="providerCode" name="providerCode" data-empty-msg="企业编号不能为空！"  value="<?php echo $providerCode;?>" <?php if($status==2){echo "readonly";}?>>
      </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" class="input-xlarge input-xfat" id="corporate" name="corporate" data-rules="required" data-empty-msg="法人代表不能为空！"  value="<?php echo $corporate;?>">
      </div>
    </div>
    <div class="control-group">
      <label for="lockPhone" class="control-label v-top"><span class="required">*</span>法人手机：</label>
      <div class="controls">
        <input type="tel" class="input-xlarge input-xfat" id="lockPhone" name="lockPhone" data-rules="required|mobile" data-empty-msg="法人手机不能为空！" value="<?php echo $lockPhone;?>">
      </div>
    </div>
        ...
        <span class="sui-dropdown dropdown-bordered select province">
          <span class="dropdown-inner">
            <a id="drop12" role="button" data-toggle="dropdown" href="#" class="dropdown-toggle">
              ...
              <i class="caret"></i>
              <span><?php echo $province_cur['name']?$province_cur['name']:'省份';?></span></a>
        ...
        <span class="sui-dropdown dropdown-bordered select city">
          <span class="dropdown-inner">
            <a id="drop12" role="button" data-toggle="dropdown" href="#" class="dropdown-toggle">
              ...
              <i class="caret"></i>
              <span><?php echo $city_cur['name']?$city_cur['name']:'城市';?></span></a>
            <ul id="menu12" role="menu" aria-labelledby="drop12" class="sui-dropdown-menu">
        ...
        <span class="sui-dropdown dropdown-bordered select area">
          <span class="dropdown-inner">
            <a id="drop12" role="button" data-toggle="dropdown" href="#" class="dropdown-toggle">
              ...
              <i class="caret"></i>
              <span><?php echo $area_cur['name']?$area_cur['name']:'城市';?></span></a>
            <ul id="menu12" role="menu" aria-labelledby="drop12" class="sui-dropdown-menu">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" class="input-xlarge input-xfat" id="website" name="website" value="<?php echo $website;?>">
      </div>
    </div>
  ...
  <div class="tab2" style="display: none;">
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" class="input-xlarge input-xfat" id="industry" name="industry" data-rules="required" data-empty-msg="所属行业不能为空！"  value="<?php echo $industry;?>">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" class="input-xlarge input-xfat" id="product" name="product" data-rules="required" data-empty-msg="主营产品不能为空！"  value="<?php echo $product;?>">
      </div>
    </div>
    <div class="control-group">
      <label for="product" class="control-label"><span class="required">*</span>营业执照/信用代码：</label>
      <div class="controls">
        <input type="text" class="input-xlarge input-xfat" id="creditCode" name="creditCode" data-rules="required" data-empty-msg="营业执照/信用代码不能为空！"  value="<?php echo $creditCode;?>">
      </div>
    </div>
    ...
    <div class="control-group">
      ...
      <div class="controls" id="upload_cre">
        ...
        <a href="javascript:void(0);" id="bigPhoto" class="sui-btn btn-xlarge btn-primary" onclick="listphoto();">查看大图</a>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" class="input-xlarge input-xfat" id="taxCode" name="taxCode" value="<?php echo $taxCode;?>">
      </div>
    </div>
    <div class="control-group">
      ...
      <div class="controls" id="upload_tax">
        ...
        <a href="javascript:void(0);" id="bigPhoto1" class="sui-btn btn-xlarge btn-primary" onclick="listphoto1();">查看大图</a>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <textarea id="description" name="description" data-rules="required" data-empty-msg="企业简介不能为空！" style="width: 550px;height:200px;"><?php echo $description;?></textarea>
      </div>
    </div>
    ...
    <div class="control-group followRadio">
      ...
      <div class="controls">
        <?php if($status==1):?>
        <label class="radio-pretty inline <?php if(strrpos($status,'1')>-1){echo "checked";}?>">
          <input type="radio" <?php if(strrpos($status,'1')>-1){echo 'checked="checked"';}?> value="1" name="status_radio"><span>待审核</span>
        </label>
        <label class="radio-pretty inline <?php if(strrpos($status,'2')>-1){echo "checked";}?>">
          <input type="radio" <?php if(strrpos($status,'2')>-1){echo 'checked="checked"';}?> value="2" name="status_radio"><span>已审核</span>
        </label>
        <label class="radio-pretty inline <?php if(strrpos($status,'3')>-1){echo "checked";}?>">
          <input type="radio" <?php if(strrpos($status,'3')>-1){echo 'checked="checked"';}?> value="3" name="status_radio"><span>驳回</span>
        </label>
        <?php elseif($status==2):?>
        <label class="radio-pretty inline <?php if(strrpos($status,'2')>-1){echo "checked";}?>">
          <input type="radio" <?php if(strrpos($status,'2')>-1){echo 'checked="checked"';}?> value="2" name="status_radio"><span>已审核</span>
        ...
        <?php elseif($status==3):?>
        <label class="radio-pretty inline <?php if(strrpos($status,'3')>-1){echo "checked";}?>">
          <input type="radio" <?php if(strrpos($status,'3')>-1){echo 'checked="checked"';}?> value="3" name="status_radio"><span>已驳回</span>
        </label>
        <?php endif;?>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <textarea id="reject" name="reject" style="width: 550px;height:100px;"><?php echo $reject;?></textarea>
      </div>
    </div>
    <?php endif;?>
    <div class="control-group">
...
$(function(){
  ...
  SAYIMO.dialogView('js_add_goods','商品','tirgger_goods_btn','base_supplier/viewstudents','js_btn_item_disabled',goods_callback);
...
$(function(){
  ...
  var _opts = {};
  _opts.url = OO._SRVPATH + 'base_supplier/save';  
...
$(function(){
  ...
  $(".province").on('click', 'ul li', function(){
    ...
    if( curId !== clickId ){
      $.ajax({
        type:'post',
        url:'<?php echo APP_URL?>base_supplier/getCityJsonList',
  ...
  $(".city").on('click', 'ul li', function(){
    ...
    if( curId !== clickId ){
      $.ajax({
        type:'post',
        url:'<?php echo APP_URL?>base_supplier/getAreaJsonList',
  ...
  $.confirm({
    ...
    okHidden: function() {
      ...
      $.ajax({
        type    : "post",
        async   : false,
        url     : '<?php echo APP_URL."base_supplier/photodelete";?>',
        data    : "id=" + delItem.attr('photoId') + "&infoid=" + $("#id").val(),
        dataType: 'json',
        success : function (data){
          if (data['data']['status'] == 1){
            $.alert(data['data']['msg']);
            // SAYIMO.go_url("<?php echo APP_URL;?>base_supplier/edit?id="+$("#id").val());
          }else{
            $.alert(data['data']['msg']);
          }
        }
...
$(function(){
  ...
  SAYIMO.dialogView('js_add_industry','所选择的行业（您最多能选择5项）','industry','base_supplier/viewIndustry','js_btn_item',callback_dialog);
});
//对话框回调函数
