...
<form id="provider-form" class="sui-form form-horizontal sui-validate" novalidate="novalidate">
  <div class="tab1">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <a href="javascript:void(0);" class="sui-btn btn-xlarge btn-primary" onclick="s_navclick('check');">下一页</a>
      </div>
    </div>
  </div>
  <div class="tab2" style="display: none;">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <div id="description" name="description" style="width: 550px;height:200px;"><?php echo $description;?></div>
      </div>
    </div>
    ...
    <div class="control-group followRadio">
      ...
      <div class="controls">
        <label class="radio-pretty inline <?php if(strrpos($status,'1')>-1){echo "checked";}?>">
          <input type="radio" <?php if(strrpos($status,'1')>-1){echo 'checked="checked"';}?> value="1" data-rules="required" name="status_radio"><span>待审核</span>
        </label>
