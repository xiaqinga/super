...
_pagedata.url = "base_moldbaby/ajaxaddgoods_info?id="+$("#id").val()+"&goodsType=<?php echo $goodsType;?>&key_type="+key_type+"&key="+encodeURIComponent(key)+"&pagesize=<?php echo $page['pagesize'];?>&page=";
...
$(function(){
  ...
  SAYIMO.dialogView('js_add_goods','商品','tirgger_goods_btn','base_moldbaby/viewGoods?goodsType=<?php echo $goodsType;?>&goodsIds='+$("#goodsIds").val(),'js_btn_item_disabled',goods_callback);
