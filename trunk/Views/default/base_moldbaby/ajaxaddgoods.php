...
<table class="sui-table table-bordered-simple">
  ...
  <?php if(!empty($list)){?>
    ...
    <tr>
      ...
      <td class="center"><input min="0" type="number" name="addgoods_originalPrice" class="input-medium" value="<?php echo $rs['originalPrice'];?>"></td>
      <td class="center"><input min="0" type="text" name="addgoods_activityPrice" class="input-medium" value="<?php echo $rs['activityPrice'];?>"></td>
      <td class="center"><input min="0" type="number" name="addgoods_activityNum" class="input-medium" value="<?php echo $rs['activityNum'];?>"></td>
      <td class="center">
      	<?php echo form_a_auth(array('content'=>'删除','class'=>'btn-link base_activity-delete','onclick'=>'deleteId(this,'.$rs['goodsId'].')','rid'=>$rs['id'],'img'=>'delete.png'));?>
      </td>
      <td></td>
    </tr>
    <?php }?>
