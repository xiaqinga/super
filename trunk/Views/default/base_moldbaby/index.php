...
<div class="content-top ">
	<form class="sui-form" id="search">
	 <div class="controls">
      ...
      <button type="submit" id="search-bn" data-url="<?php echo APP_URL ;?>base_moldbaby/index" class="sui-btn btn-large btn-primary">查询</button>
      <?php echo form_a_auth(array('content'=>'添加爆款','check'=>'base_moldbaby/add','class'=>'btn-large','url'=>APP_URL.'base_moldbaby/edit?ref='.$ref));?>
    </div>
	</form>
</div>
...
_pagedata.url = "base_moldbaby/ajaxIndex?key_type="+key_type+"&key="+key+"&pagesize=<?php echo $page['pagesize'];?>&page=";
