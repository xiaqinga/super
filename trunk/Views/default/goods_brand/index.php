<div class="content-top">
  <form class="sui-form" id="search">
    <div class="controls">
      ...
      <button type="submit" id="search-bn" data-url="goods_brand/index" class="sui-btn btn-large btn-primary">查询</button>
      <?php echo form_a_auth(array('content'=>'添加','check'=>'goods_brand/add','class'=>'btn-large','url'=>APP_URL.'goods_brand/edit?ref='.$ref));?>
    </div>
  </form>
</div>
<div class="goods_brand-list">
</div>
...
_pagedata.url = "goods_brand/ajaxIndex?key_type="+key_type+"&key="+key+"&pagesize=<?php echo $page['pagesize'];?>&page=";
_pagedata.container = '.goods_brand-list';
