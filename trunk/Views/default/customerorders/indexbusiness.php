...
<ul class="sui-nav nav-tabs tab-wraped">
    ...
    <li><a href="javascript:;" data-url="<?php echo APP_URL.'customerorders/indexsilver';?>" data-toggle="tab" style="border-right: 1px solid #ddd;">
      <h3 style="font-size: 14px;line-height: 0;">银商城</h3>
     </a>
   </li>
   
 
    <li class="active"><a href="javascript:;" data-url="<?php echo APP_URL.'customerorders/indexbusiness';?>" data-toggle="tab" style="border-right: 1px solid #ddd;">
...
<div class="content-top">
	<form class="sui-form" id="search">
		<div class="controls">
			...
			<button type="submit" id="search-bn" data-url="customerorders/indexbusiness" class="sui-btn btn-large btn-primary">查询</button>
		</div>
	</form>
</div>
...
_pagedata.url = "customerorders/ajaxIndexbusiness?accout="+accout+"&pagesize=<?php echo $page['pagesize'];?>&page=";
