...
<div class="content-top">
	<form class="sui-form" id="search">
		<div class="controls">
			...
			<button type="submit" id="search-bn" data-url="customerorders/index" class="sui-btn btn-large btn-primary">查询</button>
		</div>
	</form>
</div>
...
_pagedata.url = "customerorders/ajaxIndex?accout="+accout+"&pagesize=<?php echo $page['pagesize'];?>&page=";
