...
<ul class="sui-nav nav-tabs tab-wraped">
    ...
    <li><a href="javascript:;" data-url="<?php echo APP_URL.'ordersstatis/preindex';?>" data-toggle="tab" style="border-right: 1px solid #ddd;">
...
<div class="content-top">
	<form class="sui-form" id="search">
		<div class="controls">
			...
			<button type="submit" id="pr-search-bn" data-url="ordersstatis/returnindex" class="sui-btn btn-large btn-primary">查询</button>
		</div>
	</form>
</div>
<div class="customerstatis-list">
	<table class="sui-table table-bordered-simple">
	  <thead>
	    <tr class="thbk">
	      <th class="center">退货订单总数</th>
	      <th class="center">换货订单总数</th>
	      <th class="center">已退换货订单数</th>
	    </tr>
	  </thead>
	  <tbody>
	  	<tr>
	  		<td class="center"><?php echo $returnOrderCount;?></td>
	  		<td class="center"><?php echo $exchangeOrderCount;?></td>
		...
		<div class="content-top" style="margin: -3px auto;">
			<form class="sui-form" id="search">
				...
				<div class="controls">
					...
					<button type="submit" id="search-bn" data-url="ordersstatis/returnindex" class="sui-btn btn-large btn-primary">查询</button>
				</div>
			</form>
		</div>
	</div>
...
$(function(){
	...
	var datas = [
	         	{
	         		name : '退货订单数',
	         		data:[<?php echo $returnOrderCountMonth;?>]
	         	},
	         	{
	         		name : '换货订单数',
	         		data:[<?php echo $exchangeOrderCountMonth;?>]
	         	}	         	
	         ];
