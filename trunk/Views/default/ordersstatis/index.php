...
<ul class="sui-nav nav-tabs tab-wraped">
	...
	<li class="<?php echo $malltype==1?'active':''?>"><a href="javascript:;" data-url="<?php echo APP_URL.'ordersstatis/index?malltype=1';?>"data-toggle="tab">
      <h3 style="font-size: 14px;line-height: 0;">金商城订单</h3>
     </a>
    </li>


    <li class="<?php echo $malltype==2?'active':''?>"><a href="javascript:;" data-url="<?php echo APP_URL.'ordersstatis/index?malltype=2';?>" data-toggle="tab" style="border-right: 1px solid #ddd;">
      <h3 style="font-size: 14px;line-height: 0;">银商城订单</h3>
     </a>
    </li>


    <li class="<?php echo $malltype==4?'active':''?>"><a href="javascript:;" data-url="<?php echo APP_URL.'ordersstatis/index?malltype=3';?>" data-toggle="tab" style="border-right: 1px solid #ddd;">
...
<div class="content-top">
	<form class="sui-form" id="search">
		<div class="controls">
			...
			<button type="submit" id="pr-search-bn" data-url="ordersstatis/index" class="sui-btn btn-large btn-primary">查询</button>
		</div>
	</form>
</div>
	...
	<table class="sui-table table-bordered-simple">
	  <thead>
	    <tr class="thbk">
	      ...
	      <th class="center">待支付订单数</th>
	      <th class="center">待发货订单数</th>
	      <th class="center">已发货订单数</th>
	      <th class="center">待处理订单数</th>
	      <th class="center">已完成订单数</th>
	    </tr>
	  </thead>
	  <tbody>
	  	<tr>
	  		...
	  		<td class="center"><?php echo $preSendOut;?></td>
	  		<td class="center"><?php echo $offSendOut;?></td>
	  		<td class="center"><?php echo $processedOrder;?></td>
	  		<td class="center"><?php echo $offStockCount;?></td>
	  	</tr>
	  </tbody>
	</table>
</div>
		...
		<div class="content-top" style="margin: -3px auto;">
			<form class="sui-form" id="search">
				...
				<div class="controls">
					...
					<button type="submit" id="search-bn" data-url="ordersstatis/index" class="sui-btn btn-large btn-primary">查询</button>
				</div>
			</form>
		</div>
	</div>
...
$(function(){
	...
	var datas = [
	         	{
	         		name : '已完成订单数',
	         		data:[<?php echo $offStockCountMonth;?>]
	         	},
	         	{
	         		name : '订单总数',
	         		data:[<?php echo $ordersTotalMonth;?>]
	         	}	         	
	         ];
