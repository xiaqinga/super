<style type="text/css">
  ...
  <form id="confirm-form" class="sui-form">
      ...
      <input type="hidden" name="customerId" id="customerId" value="<?php echo $attr['customerId'];?>">

     <input type="hidden" name="ref" id="ref" value="<?php echo $ref;?>" >
      <div class="market_dt5">
        <div style="height:30px;background-color:#fff;margin:0px;padding:0px;padding-bottom:5px;">
          <div style="float:left;border:1px solid #00a7db;margin:9px;height:15px;"></div><span class="iconSpan">确认发货</span>
        </div>
      </div>
      ...
      <textarea rows="3" style="border:1px solid #DDDDDD;height:70px;width:53.5%;margin-left:32px" class="leaveWords"><?php echo $attr['leaveWords'];?></textarea>
...
<script type="text/javascript">
  ...
  function confirm()
  {
    ...
    $.ajax({
      type    : "post",
      async   : false,
      url     : '<?php echo APP_URL."orders_silver_goods_info/confirmSendGoods";?>',
      data    : "id=" + id + "&emsId=" + emsId + "&emsNo=" + emsNo + "&emsName=" + emsName +"&customerId=" + customerId + "&leaveWords=" + leaveWords,
      dataType: 'json',
