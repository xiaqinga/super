      ...
      <?php switch ($status):
          ...
          //待支付
              ...
              <tr class="orderTr">
                ...
                <td class="center">
                  <?php echo form_a_auth(array('content'=>'查看','class'=>'btn-link','url'=>'orders_silver_goods_info/info?id='.$rs['id'].'&ref='.urlencode($ref),'check'=>'orders_silver_goods_info/see','img'=>'check.png'));?>
                </td>
                <td class="orderTdbj2"></td>
              </tr>
        <?php break; ?>
        ...
        <?php case 2 : ?>
              ...
              <tr class="orderTr">
                ...
                <td class="center">
                  <?php echo form_a_auth(array('content'=>'查看','class'=>'btn-link','url'=>'orders_silver_goods_info/info?id='.$rs['id'].'&ref='.urlencode($ref),'check'=>'orders_silver_goods_info/see','img'=>'check.png'));?>
                  <?php echo form_a_auth(array('content'=>'确认','class'=>'btn-link','url'=>'orders_silver_goods_info/confirm?id='.$rs['id'].'&ref='.urlencode($ref),'check'=>'orders_silver_goods_info/confirm','img'=>'confirm.png'));?>
                </td>
                <td class="orderTdbj2"></td>
              </tr>
        <?php break; ?>
        ...
        <?php case 3 : ?>
              ...
              <tr class="orderTr">
                ...
                <td class="center">
                  <?php echo form_a_auth(array('content'=>'查看','class'=>'btn-link','url'=>'orders_silver_goods_info/info?id='.$rs['id'].'&status='.$status.'&ref='.urlencode($ref),'check'=>'orders_silver_goods_info/see','img'=>'check.png'));?>&nbsp;&nbsp;
                  <?php 
                    if($rs['ordersNo'] && $rs['emsName']){
                      echo form_a_auth(array('content'=>'查看物流','class'=>'btn-primary','url'=>'orders_silver_goods_info/logistics?id='.$rs['id'].'&ref='.urlencode($ref),'check'=>'orders_silver_goods_info/view_logistics','onclick'=>"kdniao.query('".$rs['emsNo']."','".$rs['emsName']."')"));
                    }else{
                      echo '不需要物流';
                    }
                  ?>
        ...
        <?php case 7 : ?>
              ...
              <tr class="orderTr">
                ...
                <td class="center">
                  ...
                  <?php 
                    if($rs['ordersNo'] && $rs['emsName']){
                      echo form_a_auth(array('content'=>'查看物流','class'=>'btn-primary','url'=>'orders_silver_goods_info/logistics?id='.$rs['id'].'&ref='.urlencode($ref),'check'=>'orders_silver_goods_info/view_logistics','onclick'=>"kdniao.query('".$rs['ordersNo']."','".$rs['emsName']."')"));
                    }else{
                      echo '不需要物流';
                    }
                  ?>
...
function sendGoods(){
  ...
  $.confirm({
    ...
    backdrop: true,
    okHide: function() {
      SAYIMO.go_url("<?php echo APP_URL?>orders_silver_goods_info/confirmAll?ids="+JSON.stringify(ids));
    },
    hide: function() {}
  });
}
