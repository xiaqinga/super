...
<ul class="sui-nav nav-tabs nav-xlarge">
  <li class="active" onclick="s_navclick('index');"><a>活动管理</a></li>
	 ...
	 <div class="controls">
      <span class="sui-dropdown dropdown-bordered select"><span class="dropdown-inner"><a role="button" href="javascript:void(0);" data-toggle="dropdown" class="dropdown-toggle">
        ...
        <ul role="menu" aria-labelledby="drop2" class="sui-dropdown-menu">
          ...
          <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:void(0);" value="activityName">名称</a></li>
      ...
      <button type="submit" id="search-bn" data-url="<?php echo APP_URL ;?>base_activity/index" class="sui-btn btn-large btn-primary">查询</button>
      <?php echo form_a_auth(array('content'=>'添加活动','check'=>'base_activity/add','class'=>'btn-large','url'=>APP_URL.'base_activity/edit?ref='.$ref));?>
    </div>
	</form>
</div>
...
_pagedata.url = "base_activity/ajaxIndex?key_type="+key_type+"&key="+key+"&pagesize=<?php echo $page['pagesize'];?>&page=";
