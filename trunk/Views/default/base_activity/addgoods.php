...
_pagedata.url = "base_activity/ajaxaddgoods?id="+$("#id").val()+"&goodsType=<?php echo $goodsType;?>&key_type="+key_type+"&key="+encodeURIComponent(key)+"&pagesize=<?php echo $page['pagesize'];?>&page=";
...
function addGoodsTosave(){
  ...
  $.ajax({
    type    : "post",
    async   : false,
    url     : '<?php echo APP_URL."base_activity/saveb";?>',
    data    : {"id":id, "goodsIds":goodsIds, "itemsArr":JSON.stringify(itemsArr)},
    dataType: 'json',
