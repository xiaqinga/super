<ul class="sui-nav nav-tabs nav-xlarge" style="margin-top: 8px;">
  ...
  <li class="active" onclick="s_navclick('indexdetail');"><a>收入明细</a></li>
...
_pagedata.url = "base_recharge/ajaxIndexdetail?key_type="+key_type+"&key="+key+"&pagesize=<?php echo $page['pagesize'];?>&page=";
