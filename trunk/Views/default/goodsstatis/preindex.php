...
<ul class="sui-nav nav-tabs tab-wraped">
	<?php if(auth_check_permissions('goodsstatis/index')){?>
	<li><a href="javascript:;" data-url="<?php echo APP_URL.'goodsstatis/index';?>" data-toggle="tab">
      <h3 style="font-size: 14px;line-height: 0;">普通商品</h3>
     </a>
    </li>
    <?php }?>
    <?php if(auth_check_permissions('goodsstatis/preindex')){?>
    <li class="active"><a href="javascript:;" data-toggle="tab" style="border-right: 1px solid #ddd;">
      <h3 style="font-size: 14px;line-height: 0;">预约商品</h3>
     </a>
    </li>
    <?php }?>
</ul>
