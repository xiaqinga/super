...
<div class="content-top">
  <form class="sui-form" id="search">
    <div class="controls">
      ...
      <button type="submit" id="search-bn" data-url="base_union_class/index" class="sui-btn btn-large btn-primary">查询</button>
      <?php echo form_a_auth(array('content'=>'添加','class'=>'btn-large','check'=>'base_union_class/edit','url'=>APP_URL.'base_union_class/edit?ref='.$ref));?>
...
_pagedata.url = "base_union_class/ajaxIndex?key_type="+key_type+"&key="+key+"&pagesize=<?php echo $page['pagesize'];?>&page=";
