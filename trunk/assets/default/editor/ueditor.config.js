...
(function () {
	...
	window.UEDITOR_HOME_URL = ('https:' == document.location.protocol) ? 'https://' : 'http://'+window.location.host+'/assets/default/editor/';
    ...
    window.UEDITOR_CONFIG = {
       ...
       /* , toolbars: [[
		...
		, toolbars: [[
			...
			'customstyle', 'paragraph', 'fontfamily', 'fontsize', '|',
		 'insertimage', 'emotion', 'scrawl', 'insertvideo', 'music', 'link', 'map', 'gmap','|',
		'print', 'preview', 'searchreplace', 'drafts', 'help'
		]]
