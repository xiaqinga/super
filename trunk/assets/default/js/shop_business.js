    ...
    */
    duplication.get_size_attr = function(o,k) {
        ...
        $.ajax({
            type    : "post",
            async   : false,
            url     : OO._SRVPATH+'goods_list_business/sizeAttr',
            data    : "id=" + idata.id,
            dataType: 'json',
        ...
        okHide: function() {
          ...
          for (var i = formsizeGoods.length - 1; i >= 0; i--) {
              ...
              var sizeItems = {};
                  ...
                  //sizeItems.restockPrice = backend.comomn.save_json(formsizeGoods[i].querySelector(".js_restockPrice").value);
          ...
          $.ajax({
              type    : "post",
              async   : false,
              url     : OO._SRVPATH+'goods_list_business/savesizegoods', 
              ...
              success : function (data)
              {
                canupdate = data['msg'];
                  $.alert("保存成功");
                  SAYIMO.go_url(OO._SRVPATH+"goods_list_business/normsedit?id="+$("#id").val());
              }
          });
    ...
    */
    duplication.saveSize = function() {
        ...
        $.ajax({
            type    : "post",
            async   : false,
            url     : OO._SRVPATH+'goods_list_business/savesize',
