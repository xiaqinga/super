...
;(function(win){
	var settings,
		defaultsetting = {title:"提示",content:"",width:"400",height:"200",url:"",close:true,confirmFun: new Object,cancelFun: new Object},
		contentWidth = 0,
		contentHeight = 0;			
	win.popup={		
	...
	function open(setting, caller){
		...
		switch(caller){
			...
			case "confirm" :
				...
				popupwin.append("<div class='btn'><input type='button' id='popupconfirmbtn' class='confirmbtn popupease' value='确定' /><input type='button' id='popupcancelbtn' class='confirmbtn popupease' value='取消' /><div>")
			break;
			case "iframe" :
