...
var Size = (function(duplication) {
    ...
    */
    duplication.qq = function(dd){
        ...
        var oo = $(dd).parent().parent().find("input[name='js_preferentialPrice']").val();
        var aa = '';
        if(oo&&ee){
            aa = (ee/oo).toFixed(2);
            if(aa<6||aa>10){
                ...
                $.alert('倍数范围值只能为6-10,例:销售价10元,进货价范围为1-1.67元（倍数=销售价/进货价)');
                return;
            } 
        }
    ...
    duplication.get_size_attr = function(o,k) {
        ...
        $.ajax({
            type    : "post",
            async   : false,
            url     : OO._SRVPATH+'goods_list_silver/sizeAttr',
            data    : "id=" + idata.id,
            dataType: 'json',
            ...
            if (o.checked){
                ...
                if(org_select_a_id && !org_select_b_id){  //仅勾选选项1的值
                    ...
                    tr.innerHTML =  '<td class="js_sizes_a" style="word-break: break-all;word-wrap:break-word;">'+sizeItem.Cur[0].value+'</td>'+
                                    ...
                                    '<td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_stockNum" type="text" value=""></td>'+
                                    '<td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_weight" type="text" value=""></td>'+
                                    '<td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_originalPrice" name="js_originalPrice" type="text" value="" placeholder="6-10之间的数值" readonly="readonly"></td>'+
                                    '<td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_preferentialPrice" name="js_preferentialPrice" type="text" value="" onchange="Size.zz(this);"></td>';
                    // <input min="0" class="input-medium js_originalPrice" type="text" value="">
                    tbody.appendChild(tr);
                }
                    ...
                    for (var i = sizeItem.B.length - 1; i >= 0; i--) {
                        for (var j = sizeItem.Cur.length - 1; j >= 0; j--) {
                            ...
                            tr.innerHTML =  '<td class="js_sizes_a" style="word-break: break-all;word-wrap:break-word;">'+sizeItem.Cur[0].value+'</td>'+
                                            ...
                                            '<td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_stockNum" type="text" value=""></td>'+
                                            '<td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_weight" type="text" value=""></td>'+
                                            '<td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_originalPrice" type="text" name="js_originalPrice" value="" placeholder="6-10之间的数值" readonly="readonly"></td>'+
                                            '<td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_preferentialPrice" name="js_preferentialPrice" type="text" onchange="Size.zz(this);" value=""></td>';
                            // <input min="0" class="input-medium js_originalPrice" type="text" value="">
                            tbody.appendChild(tr);
                        }
                    }
                    ...
                    for (var i = sizeItem.A.length - 1; i >= 0; i--) {
                        for (var j = sizeItem.Cur.length - 1; j >= 0; j--) {
                            ...
                            tr.innerHTML =  '<td class="js_sizes_a" style="word-break: break-all;word-wrap:break-word;">'+sizeItem.A[i].value+'</td>'+
                                            ...
                                            '<td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_weight" type="text" value=""></td>'+
                                            '<td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_originalPrice" type="text" name="js_originalPrice" value="" placeholder="6-10之间的数值" readonly="readonly"></td>'+
                                            '<td style="word-break: break-all;word-wrap:break-word;"><input min="0" class="input-medium js_preferentialPrice" type="text" name="js_preferentialPrice" value="" onchange="Size.zz(this);"></td>';
                            // <input min="0" class="input-medium js_originalPrice" type="text" value="">
                            tbody.appendChild(tr);
                        }
                    }
        ...
        okHide: function() {
          ...
          for (var i = formsizeGoods.length - 1; i >= 0; i--) {
              ...
              var sizeItems = {};
                  ...
                  //     return;
                  }else if(!sizeItems.restockPrice) {
                      $.alert("请输入进货价!");  
          ...
          $.ajax({
              type    : "post",
              async   : false,
              url     : OO._SRVPATH+'goods_list_silver/savesizegoods', 
              ...
              success : function (data)
              {
                canupdate = data['msg'];
                  $.alert("保存成功");
                  SAYIMO.go_url(OO._SRVPATH+"goods_list_silver/normsedit?id="+$("#id").val());
              }
          });
    ...
    */
    duplication.saveSize = function() {
        ...
        $.ajax({
            type    : "post",
            async   : false,
            url     : OO._SRVPATH+'goods_list_silver/savesize',
