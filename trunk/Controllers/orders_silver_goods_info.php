...
class orders_silver_goods_info extends common {
	...
	public function index()
	{
		...
		$this->view($data,'orders_silver_goods_info/index');
	}
	...
	public function ajaxIndex(){
		...
		$data  = array(
			...
			'statusList' => $this->public_dict['orderStatusList'],
			'payList' => $payList,
			'ref' => $this->queryVar('ref' , APP_URL . 'orders_silver_goods_info/index?'.$key_type.'='.$key.'&page='.$page.'&status='.$status)
		);
		$this->setActionLog('orders_silver_goods_info','QUERY','查询银商城订单列表');
		$this->view($data,'orders_silver_goods_info/ajaxindex');
	}
	...
	public function info()
	{
		...
		$data  = array(
			...
			'id' => $id,
			'status'=>$status,
			'ref' => $this->queryVar('ref', APP_URL . 'orders_silver_goods_info/index')
		);
		$this->setActionLog('orders_silver_goods_info','QUERY','查询银商城订单详情');
		$this->view($data,'orders_silver_goods_info/info');
	}
	...
	public function confirm()
	{
		...
		$data  = array(
			...
			'goods' => $orderGoods['data']['list'],
			'id' => $id,
			'ref' => APP_URL . 'orders_silver_goods_info/index?status=2',
		);
		$this->view($data,'orders_silver_goods_info/confirm');
	}
	...
	public function confirmAll()
	{
		...
		$this->view($data,'orders_silver_goods_info/confirmall');
	}
  ...
  function exportOrder(){
    ...
    echo "</table>";
    $this->setActionLog('orders_silver_goods_info','QUERY','导出银商城订单列表');
    return (true);  
  }
